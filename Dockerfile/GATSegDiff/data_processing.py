...
def crop25d_testset_LiVS(root_path, save_root_path, slices=3): #   
    ...
    for root, dirs, files in os.walk(root_path): 
        ...
        for name in files:
            ...
            save_path_1 = os.path.join(save_root_path, 'Test25DCT_CTVolume_3slices', name.split('_')[0]+'.nii.gz')

            os.makedirs(os.path.join(save_root_path, 'Test25DCT_CTVolume_3slices'), exist_ok=True)
...
def ensemble_inference_LiVS(root_path):
    def mv(a):
